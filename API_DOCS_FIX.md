...
- **Swagger UI**: https://mern-rapid-deploy.preview.emergentagent.com/api/docs
- **ReDoc**: https://mern-rapid-deploy.preview.emergentagent.com/api/redoc
- **OpenAPI JSON**: https://mern-rapid-deploy.preview.emergentagent.com/api/openapi.json
