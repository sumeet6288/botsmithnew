...
- **Swagger UI**: https://fullstack-setup-22.preview.emergentagent.com/api/docs
- **ReDoc**: https://fullstack-setup-22.preview.emergentagent.com/api/redoc
- **OpenAPI JSON**: https://fullstack-setup-22.preview.emergentagent.com/api/openapi.json
