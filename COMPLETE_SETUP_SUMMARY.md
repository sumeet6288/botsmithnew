...
### Frontend (.env)
```bash
REACT_APP_BACKEND_URL=https://stack-with-redis.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
| Service | URL |
|---------|-----|
| **Frontend** | https://stack-with-redis.preview.emergentagent.com |
| **Backend API** | https://stack-with-redis.preview.emergentagent.com/api |
| **API Docs (Swagger)** | https://stack-with-redis.preview.emergentagent.com/api/docs |
| **Health Check** | https://stack-with-redis.preview.emergentagent.com/api/health |
...
Visit: https://stack-with-redis.preview.emergentagent.com

### 2. Test API
View API docs: https://stack-with-redis.preview.emergentagent.com/api/docs
...
- **API Documentation**: https://stack-with-redis.preview.emergentagent.com/api/docs
