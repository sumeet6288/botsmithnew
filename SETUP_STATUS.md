...
- **Public URL**: https://sub-admin-portal.preview.emergentagent.com
...
### Backend (FastAPI)
- **API Documentation**: https://sub-admin-portal.preview.emergentagent.com/docs
- **Status**: ✅ HTTP 200 - Accessible
- **API Base URL**: https://sub-admin-portal.preview.emergentagent.com/api
...
1. **Access the Application**:
   - Visit: https://sub-admin-portal.preview.emergentagent.com
   - Click "Sign In" 
...
3. **API Documentation**:
   - Visit: https://sub-admin-portal.preview.emergentagent.com/docs
