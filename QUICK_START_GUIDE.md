...
```
https://simple-token-auth.preview.emergentagent.com
```

### **API Documentation**
```
https://simple-token-auth.preview.emergentagent.com/docs
```
...
```env
REACT_APP_BACKEND_URL=https://simple-token-auth.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
**Application URL:** https://simple-token-auth.preview.emergentagent.com
