        ...
        if owner_user_id:
            ...
            if limit_check.get("reached"):
                ...
                limit_message = (
                    ...
                    f"Dashboard: {os.environ.get('FRONTEND_URL', 'https://fullstack-setup-22.preview.emergentagent.com')}"
                )
...
async def setup_messenger_webhook(
    ...
    try:
        ...
        backend_url = os.environ.get('BACKEND_URL', 'https://fullstack-setup-22.preview.emergentagent.com')
