    ...
    try:
        ...
        if chatbot.get("status") != "active":
            inactive_message = (
                ...
                f"Visit: {os.environ.get('FRONTEND_URL', 'https://fullstack-setup-26.preview.emergentagent.com')}"
            )
        ...
        if user_id:
            ...
            if limit_check.get("reached"):
                ...
                limit_message = (
                    ...
                    f"Visit your dashboard to upgrade: {os.environ.get('FRONTEND_URL', 'https://fullstack-setup-26.preview.emergentagent.com')}"
                )
                await telegram_service.send_message(
                    chat_id=chat_id,
                    text=limit_message
