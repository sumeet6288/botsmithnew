    ...
    try:
        ...
        if chatbot.get("status") != "active":
            inactive_message = (
                ...
                f"Dashboard: {os.environ.get('FRONTEND_URL', 'https://sub-model-advance.preview.emergentagent.com')}"
            )
...
async def setup_whatsapp_webhook(
    ...
    try:
        ...
        backend_url = os.environ.get('BACKEND_URL', 'https://sub-model-advance.preview.emergentagent.com')
