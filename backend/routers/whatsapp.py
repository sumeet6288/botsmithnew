        ...
        if owner_user_id:
            ...
            if limit_check.get("reached"):
                ...
                limit_message = (
                    ...
                    f"Dashboard: {os.environ.get('FRONTEND_URL', 'https://full-stack-setup-11.preview.emergentagent.com')}"
                )
...
async def setup_whatsapp_webhook(
    ...
    try:
        ...
        backend_url = os.environ.get('BACKEND_URL', 'https://full-stack-setup-11.preview.emergentagent.com')
