...
### 🎯 Main Application
**Frontend:** https://mern-rapid-deploy.preview.emergentagent.com  
- Full React application with beautiful UI
- Responsive design with Tailwind CSS
- Dark mode support

### 🔧 Backend API
**API Base:** https://mern-rapid-deploy.preview.emergentagent.com/api  
**API Documentation:** https://mern-rapid-deploy.preview.emergentagent.com/api/docs  
...
### Frontend (.env)
```bash
REACT_APP_BACKEND_URL=https://mern-rapid-deploy.preview.emergentagent.com
```
...
1. ✅ **Access Frontend:** https://mern-rapid-deploy.preview.emergentagent.com
...
curl https://mern-rapid-deploy.preview.emergentagent.com/api/health

# Get plans
curl https://mern-rapid-deploy.preview.emergentagent.com/api/plans

# API Documentation
# Visit: https://mern-rapid-deploy.preview.emergentagent.com/api/docs
```
...
1. **Test the Application:**
   - Access https://mern-rapid-deploy.preview.emergentagent.com
...
**Application URL:** https://mern-rapid-deploy.preview.emergentagent.com  
