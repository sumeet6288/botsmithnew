...
### 🎯 Main Application
**Frontend:** https://widget-color-fix.preview.emergentagent.com  
- Full React application with beautiful UI
- Responsive design with Tailwind CSS
- Dark mode support

### 🔧 Backend API
**API Base:** https://widget-color-fix.preview.emergentagent.com/api  
...
1. ✅ **Access Frontend:** https://widget-color-fix.preview.emergentagent.com
...
curl https://widget-color-fix.preview.emergentagent.com/api/health

# Get plans
curl https://widget-color-fix.preview.emergentagent.com/api/plans

# API Documentation
# Visit: https://widget-color-fix.preview.emergentagent.com/api/docs
```
...
1. **Test the Application:**
   - Access https://widget-color-fix.preview.emergentagent.com
...
**Application URL:** https://widget-color-fix.preview.emergentagent.com  
