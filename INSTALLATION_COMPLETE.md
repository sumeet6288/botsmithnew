...
### 🎯 Main Application
**Frontend:** https://quickapp-deploy.preview.emergentagent.com  
- Full React application with beautiful UI
- Responsive design with Tailwind CSS
- Dark mode support

### 🔧 Backend API
**API Base:** https://quickapp-deploy.preview.emergentagent.com/api  
**API Documentation:** https://quickapp-deploy.preview.emergentagent.com/api/docs  
...
### Frontend (.env)
```bash
REACT_APP_BACKEND_URL=https://quickapp-deploy.preview.emergentagent.com
```
...
1. ✅ **Access Frontend:** https://quickapp-deploy.preview.emergentagent.com
...
# Get plans
curl https://quickapp-deploy.preview.emergentagent.com/api/plans

# API Documentation
# Visit: https://quickapp-deploy.preview.emergentagent.com/api/docs
```
...
1. **Test the Application:**
   - Access https://quickapp-deploy.preview.emergentagent.com
...
**Application URL:** https://quickapp-deploy.preview.emergentagent.com  
