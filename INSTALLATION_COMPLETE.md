...
### 🎯 Main Application
**Frontend:** https://dev-env-builder-1.preview.emergentagent.com  
- Full React application with beautiful UI
- Responsive design with Tailwind CSS
- Dark mode support

### 🔧 Backend API
**API Base:** https://dev-env-builder-1.preview.emergentagent.com/api  
**API Documentation:** https://dev-env-builder-1.preview.emergentagent.com/api/docs  
...
1. ✅ **Access Frontend:** https://dev-env-builder-1.preview.emergentagent.com
...
curl https://dev-env-builder-1.preview.emergentagent.com/api/health

# Get plans
curl https://dev-env-builder-1.preview.emergentagent.com/api/plans

# API Documentation
# Visit: https://dev-env-builder-1.preview.emergentagent.com/api/docs
```
...
1. **Test the Application:**
   - Access https://dev-env-builder-1.preview.emergentagent.com
