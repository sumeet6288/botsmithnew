...
### 🎯 Main Application
**Frontend:** https://widget-response-fix.preview.emergentagent.com  
- Full React application with beautiful UI
- Responsive design with Tailwind CSS
- Dark mode support

### 🔧 Backend API
**API Base:** https://widget-response-fix.preview.emergentagent.com/api  
**API Documentation:** https://widget-response-fix.preview.emergentagent.com/api/docs  
...
### Frontend (.env)
```bash
REACT_APP_BACKEND_URL=https://widget-response-fix.preview.emergentagent.com
```
...
1. ✅ **Access Frontend:** https://widget-response-fix.preview.emergentagent.com
...
# Get plans
curl https://widget-response-fix.preview.emergentagent.com/api/plans

# API Documentation
# Visit: https://widget-response-fix.preview.emergentagent.com/api/docs
```
...
1. **Test the Application:**
   - Access https://widget-response-fix.preview.emergentagent.com
...
**Application URL:** https://widget-response-fix.preview.emergentagent.com  
