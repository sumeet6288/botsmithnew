...
### 🎯 Main Application
**Frontend:** https://db-connect-preview-1.preview.emergentagent.com  
- Full React application with beautiful UI
- Responsive design with Tailwind CSS
- Dark mode support

### 🔧 Backend API
**API Base:** https://db-connect-preview-1.preview.emergentagent.com/api  
**API Documentation:** https://db-connect-preview-1.preview.emergentagent.com/api/docs  
...
### Frontend (.env)
```bash
REACT_APP_BACKEND_URL=https://db-connect-preview-1.preview.emergentagent.com
```
...
1. ✅ **Access Frontend:** https://db-connect-preview-1.preview.emergentagent.com
...
curl https://db-connect-preview-1.preview.emergentagent.com/api/health

# Get plans
curl https://db-connect-preview-1.preview.emergentagent.com/api/plans

# API Documentation
# Visit: https://db-connect-preview-1.preview.emergentagent.com/api/docs
```
...
1. **Test the Application:**
   - Access https://db-connect-preview-1.preview.emergentagent.com
...
**Application URL:** https://db-connect-preview-1.preview.emergentagent.com  
