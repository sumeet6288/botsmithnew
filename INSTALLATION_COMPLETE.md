...
### 🎯 Main Application
**Frontend:** https://sub-admin-portal.preview.emergentagent.com  
- Full React application with beautiful UI
- Responsive design with Tailwind CSS
- Dark mode support

### 🔧 Backend API
**API Base:** https://sub-admin-portal.preview.emergentagent.com/api  
**API Documentation:** https://sub-admin-portal.preview.emergentagent.com/api/docs  
...
### Frontend (.env)
```bash
REACT_APP_BACKEND_URL=https://sub-admin-portal.preview.emergentagent.com
```
...
1. ✅ **Access Frontend:** https://sub-admin-portal.preview.emergentagent.com
...
curl https://sub-admin-portal.preview.emergentagent.com/api/health

# Get plans
curl https://sub-admin-portal.preview.emergentagent.com/api/plans

# API Documentation
# Visit: https://sub-admin-portal.preview.emergentagent.com/api/docs
```
...
1. **Test the Application:**
   - Access https://sub-admin-portal.preview.emergentagent.com
...
**Application URL:** https://sub-admin-portal.preview.emergentagent.com  
