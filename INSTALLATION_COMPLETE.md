...
### 🎯 Main Application
**Frontend:** https://rapid-stack-setup.preview.emergentagent.com  
- Full React application with beautiful UI
- Responsive design with Tailwind CSS
- Dark mode support

### 🔧 Backend API
**API Base:** https://rapid-stack-setup.preview.emergentagent.com/api  
**API Documentation:** https://rapid-stack-setup.preview.emergentagent.com/api/docs  
...
### Frontend (.env)
```bash
REACT_APP_BACKEND_URL=https://rapid-stack-setup.preview.emergentagent.com
```
...
1. ✅ **Access Frontend:** https://rapid-stack-setup.preview.emergentagent.com
...
curl https://rapid-stack-setup.preview.emergentagent.com/api/health

# Get plans
curl https://rapid-stack-setup.preview.emergentagent.com/api/plans

# API Documentation
# Visit: https://rapid-stack-setup.preview.emergentagent.com/api/docs
```
...
1. **Test the Application:**
   - Access https://rapid-stack-setup.preview.emergentagent.com
...
**Application URL:** https://rapid-stack-setup.preview.emergentagent.com  
