...
### 🎯 Main Application
**Frontend:** https://whitelabel-widget.preview.emergentagent.com  
- Full React application with beautiful UI
- Responsive design with Tailwind CSS
- Dark mode support

### 🔧 Backend API
**API Base:** https://whitelabel-widget.preview.emergentagent.com/api  
**API Documentation:** https://whitelabel-widget.preview.emergentagent.com/api/docs  
...
### Frontend (.env)
```bash
REACT_APP_BACKEND_URL=https://whitelabel-widget.preview.emergentagent.com
```
...
1. ✅ **Access Frontend:** https://whitelabel-widget.preview.emergentagent.com
...
# Get plans
curl https://whitelabel-widget.preview.emergentagent.com/api/plans

# API Documentation
# Visit: https://whitelabel-widget.preview.emergentagent.com/api/docs
```
...
1. **Test the Application:**
   - Access https://whitelabel-widget.preview.emergentagent.com
...
**Application URL:** https://whitelabel-widget.preview.emergentagent.com  
